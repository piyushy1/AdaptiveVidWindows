...
#CANDIDATE_RESOLUTION_SET = [(500, 500), (1000, 1000), (1920, 1080)]
CANDIDATE_RESOLUTION_SET = [(288, 162), (320,180), (480,270),(640,360),(960,540)]
            ...
            if len(object_present) == 0:
                ...
                if prev_res_flag == True:
                    ...
                    if resolution_set[resolution_middle] != CANDIDATE_RESOLUTION_SET[-1]:
                        ...
                        return object_present, CANDIDATE_RESOLUTION_SET[
                            0]  # if resolution not find till end return lowest resolution
...
def resize_micro_batch(microbatch, keyframe_resolution):
    for frames in microbatch:
        # function to avoid slide and range window condition
