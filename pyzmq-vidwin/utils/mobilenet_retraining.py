...
train_generator=train_datagen.flow_from_directory('/home/dhaval/piyush/ViIDWIN/Datasets_VIDWIN/voc_training',
                                                 target_size=(224,224),
                                                 color_mode='rgb',
                                                 batch_size=32,
...
validation_generator=train_datagen.flow_from_directory('/home/dhaval/piyush/ViIDWIN/Datasets_VIDWIN/voc_validation',
                                                 target_size=(224,224),
                                                 color_mode='rgb',
                                                 batch_size=32,
                                                 class_mode='categorical',
...
model.save('mobilenet_model_voc.h5')
