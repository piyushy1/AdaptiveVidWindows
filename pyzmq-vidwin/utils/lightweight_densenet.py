...
def prepare_image(file):
    ...
    return k.applications.densenet.preprocess_input(img_array_expanded_dims)
...
def create_lightweight_densenet(layer_name, number):
    base_model=DenseNet121(weights='imagenet',include_top=False) #imports the mobilenet model
    ...
    model.save('densenet121_model_voc_20class_ep_100_sgd_layer_'+str(len(model.layers))+'.h5')
...
for number in layer:
    ...
    print(layer_name)
    create_lightweight_densenet(layer_name, number)